...
Location.create(name: "Sukiennice", description: "Sukiennice w Krakowie w przeszłości spełniały funkcje handlowe i nie inaczej jest dzisiaj. Znajdują się tutaj stragany z biżuterią, rękodziełem i pamiątkami. Piętro Sukiennic zajmują wystawy Galerii Polskiego Malarstwa i Rzeźby XIX wieku.")
Location.create(name: "Zamek Królewski", description: "Zamek Królewski na Wawelu leży na Wzgórzu Wawelskim przy lewym brzegu Wisły. Ta siedziba wielu władców znalazł się na Liście Światowego Dziedzictwa Kulturowego UNESCO. Warto także zajrzeć do Smoczej Jamy, w której niegdyś podobno żył smok.")
